...
namespace ForumBE.Services.User
{
    public interface IUserService
    {
        ...
        Task<PagedList<UserResponseDto>> GetAllUserByCondition(PaginationDto input, AdvancedUserSearchRequestDto condition);
        ...
        Task<bool> UpdateUserByAdminAsync(UserChangeInforByAdminRequestDto input);
        Task<bool> AddUserByAdmin(AddUserByAdminRequestDto input);
    }
}
