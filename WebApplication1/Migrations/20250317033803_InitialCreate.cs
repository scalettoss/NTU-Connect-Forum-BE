        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warnings_Users_IssuedBy",
                        column: x => x.IssuedBy,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DetectionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostId = table.Column<int>(type: "int", nullable: false),
                    ModelPrediction = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScamDetections", x => x.DetectionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReportStatusId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReportId = table.Column<int>(type: "int", nullable: false),
                    ReportStatusDescription = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReportStatuses_Users_HandledBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportStatuses_HandledBy",
                table: "ReportStatuses",
                column: "HandledBy");

            migrationBuilder.CreateIndex(
                name: "IX_ReportStatuses_IsProcessed",
                table: "ReportStatuses",
                column: "IsProcessed");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScamDetections_ModelPrediction",
                table: "ScamDetections",
                column: "ModelPrediction");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warnings_CreatedAt",
                table: "Warnings",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Warnings_IssuedBy",
                table: "Warnings",
                column: "IssuedBy");
